...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceNames.set ("Pickup", "assets/data/pickup.wav");
			resourceTypes.set ("Pickup", "sound");
			resourceNames.set ("Click", "assets/data/click.wav");
			resourceTypes.set ("Click", "sound");
			resourceNames.set ("Jump", "assets/data/jump.wav");
			resourceTypes.set ("Jump", "sound");
			resourceNames.set ("Hurt", "assets/data/hurt.wav");
			resourceTypes.set ("Hurt", "sound");
			resourceNames.set ("Ambient", "assets/data/surreal_ambient.mp3");
			resourceTypes.set ("Ambient", "music");
			resourceNames.set ("Upbeat", "assets/data/etherial_hibpm.mp3");
			resourceTypes.set ("Upbeat", "music");
			resourceNames.set ("Beat", "assets/data/standard_beat.mp3");
