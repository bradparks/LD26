...
Void Assets_obj::initialize( ){
{
		...
		if ((!(::nme::installer::Assets_obj::initialized))){
			...
			HX_STACK_LINE(45)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("Pickup"),HX_CSTRING("assets/data/pickup.wav"));
			HX_STACK_LINE(46)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("Pickup"),HX_CSTRING("sound"));
			HX_STACK_LINE(47)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("Click"),HX_CSTRING("assets/data/click.wav"));
			HX_STACK_LINE(48)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("Click"),HX_CSTRING("sound"));
			HX_STACK_LINE(49)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("Jump"),HX_CSTRING("assets/data/jump.wav"));
			HX_STACK_LINE(50)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("Jump"),HX_CSTRING("sound"));
			HX_STACK_LINE(51)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("Hurt"),HX_CSTRING("assets/data/hurt.wav"));
			HX_STACK_LINE(52)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("Hurt"),HX_CSTRING("sound"));
			HX_STACK_LINE(53)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("Ambient"),HX_CSTRING("assets/data/surreal_ambient.mp3"));
			HX_STACK_LINE(54)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("Ambient"),HX_CSTRING("music"));
			HX_STACK_LINE(55)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("Upbeat"),HX_CSTRING("assets/data/etherial_hibpm.mp3"));
			HX_STACK_LINE(56)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("Upbeat"),HX_CSTRING("music"));
			HX_STACK_LINE(57)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("Beat"),HX_CSTRING("assets/data/standard_beat.mp3"));
			HX_STACK_LINE(58)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("Beat"),HX_CSTRING("music"));
			HX_STACK_LINE(59)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/beebTiles.pxi"),HX_CSTRING("assets/beebTiles.pxi"));
			HX_STACK_LINE(60)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/beebTiles.pxi"),HX_CSTRING("binary"));
			HX_STACK_LINE(61)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/cPower.png"),HX_CSTRING("assets/cPower.png"));
			HX_STACK_LINE(62)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/cPower.png"),HX_CSTRING("image"));
			HX_STACK_LINE(63)
			...
			HX_STACK_LINE(93)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/data/click.wav"),HX_CSTRING("assets/data/click.wav"));
			HX_STACK_LINE(94)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/data/click.wav"),HX_CSTRING("sound"));
			HX_STACK_LINE(95)
			...
			HX_STACK_LINE(101)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/data/etherial_hibpm.mp3"),HX_CSTRING("assets/data/etherial_hibpm.mp3"));
			HX_STACK_LINE(102)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/data/etherial_hibpm.mp3"),HX_CSTRING("music"));
			HX_STACK_LINE(103)
			...
			HX_STACK_LINE(109)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/data/hurt.wav"),HX_CSTRING("assets/data/hurt.wav"));
			HX_STACK_LINE(110)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/data/hurt.wav"),HX_CSTRING("sound"));
			HX_STACK_LINE(111)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/data/jump.wav"),HX_CSTRING("assets/data/jump.wav"));
			HX_STACK_LINE(112)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/data/jump.wav"),HX_CSTRING("sound"));
			HX_STACK_LINE(113)
			...
			HX_STACK_LINE(121)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/data/pickup.wav"),HX_CSTRING("assets/data/pickup.wav"));
			HX_STACK_LINE(122)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/data/pickup.wav"),HX_CSTRING("sound"));
			HX_STACK_LINE(123)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/data/standard_beat.mp3"),HX_CSTRING("assets/data/standard_beat.mp3"));
			HX_STACK_LINE(124)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/data/standard_beat.mp3"),HX_CSTRING("music"));
			HX_STACK_LINE(125)
			...
			HX_STACK_LINE(127)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/data/surreal_ambient.mp3"),HX_CSTRING("assets/data/surreal_ambient.mp3"));
			HX_STACK_LINE(128)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/data/surreal_ambient.mp3"),HX_CSTRING("music"));
			HX_STACK_LINE(129)
			...
			HX_STACK_LINE(149)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/door.png"),HX_CSTRING("assets/door.png"));
			HX_STACK_LINE(150)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/door.png"),HX_CSTRING("image"));
			HX_STACK_LINE(151)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/goal"),HX_CSTRING("assets/goal"));
			HX_STACK_LINE(152)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/goal"),HX_CSTRING("binary"));
			HX_STACK_LINE(153)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/goal.png"),HX_CSTRING("assets/goal.png"));
			HX_STACK_LINE(154)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/goal.png"),HX_CSTRING("image"));
			HX_STACK_LINE(155)
			...
			HX_STACK_LINE(157)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/health.png"),HX_CSTRING("assets/health.png"));
			HX_STACK_LINE(158)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/health.png"),HX_CSTRING("image"));
			HX_STACK_LINE(159)
			...
			HX_STACK_LINE(161)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/LevelFour.dam"),HX_CSTRING("assets/LevelFour.dam"));
			HX_STACK_LINE(162)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/LevelFour.dam"),HX_CSTRING("text"));
			HX_STACK_LINE(163)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/LevelFour.dam.bak"),HX_CSTRING("assets/LevelFour.dam.bak"));
			HX_STACK_LINE(164)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/LevelFour.dam.bak"),HX_CSTRING("text"));
			HX_STACK_LINE(165)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/levelOne.dam"),HX_CSTRING("assets/levelOne.dam"));
			HX_STACK_LINE(166)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/levelOne.dam"),HX_CSTRING("text"));
			HX_STACK_LINE(167)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/levelOne.dam.bak"),HX_CSTRING("assets/levelOne.dam.bak"));
			HX_STACK_LINE(168)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/levelOne.dam.bak"),HX_CSTRING("text"));
			HX_STACK_LINE(169)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/levels/mapCSV_Group1_Map1.csv"),HX_CSTRING("assets/levels/mapCSV_Group1_Map1.csv"));
			HX_STACK_LINE(170)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/levels/mapCSV_Group1_Map1.csv"),HX_CSTRING("text"));
			HX_STACK_LINE(171)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/levels/mapCSV_Group1_Map2.csv"),HX_CSTRING("assets/levels/mapCSV_Group1_Map2.csv"));
			HX_STACK_LINE(172)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/levels/mapCSV_Group1_Map2.csv"),HX_CSTRING("text"));
			HX_STACK_LINE(173)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/levels/mapCSV_LevelFour_Map1.csv"),HX_CSTRING("assets/levels/mapCSV_LevelFour_Map1.csv"));
			HX_STACK_LINE(174)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/levels/mapCSV_LevelFour_Map1.csv"),HX_CSTRING("text"));
			HX_STACK_LINE(175)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/levels/mapCSV_LevelFour_Map2.csv"),HX_CSTRING("assets/levels/mapCSV_LevelFour_Map2.csv"));
			HX_STACK_LINE(176)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/levels/mapCSV_LevelFour_Map2.csv"),HX_CSTRING("text"));
			HX_STACK_LINE(177)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/levels/mapCSV_levelOne_Map1.csv"),HX_CSTRING("assets/levels/mapCSV_levelOne_Map1.csv"));
			HX_STACK_LINE(178)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/levels/mapCSV_levelOne_Map1.csv"),HX_CSTRING("text"));
			HX_STACK_LINE(179)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/levels/mapCSV_levelOne_Map2.csv"),HX_CSTRING("assets/levels/mapCSV_levelOne_Map2.csv"));
			HX_STACK_LINE(180)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/levels/mapCSV_levelOne_Map2.csv"),HX_CSTRING("text"));
			HX_STACK_LINE(181)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/levels/mapCSV_LevelThree_Map1.csv"),HX_CSTRING("assets/levels/mapCSV_LevelThree_Map1.csv"));
			HX_STACK_LINE(182)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/levels/mapCSV_LevelThree_Map1.csv"),HX_CSTRING("text"));
			HX_STACK_LINE(183)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/levels/mapCSV_LevelThree_Map2.csv"),HX_CSTRING("assets/levels/mapCSV_LevelThree_Map2.csv"));
			HX_STACK_LINE(184)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/levels/mapCSV_LevelThree_Map2.csv"),HX_CSTRING("text"));
			HX_STACK_LINE(185)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/levels/mapCSV_LevelTwo_Map1.csv"),HX_CSTRING("assets/levels/mapCSV_LevelTwo_Map1.csv"));
			HX_STACK_LINE(186)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/levels/mapCSV_LevelTwo_Map1.csv"),HX_CSTRING("text"));
			HX_STACK_LINE(187)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/levels/mapCSV_LevelTwo_Map2.csv"),HX_CSTRING("assets/levels/mapCSV_LevelTwo_Map2.csv"));
			HX_STACK_LINE(188)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/levels/mapCSV_LevelTwo_Map2.csv"),HX_CSTRING("text"));
			HX_STACK_LINE(189)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/levels/mapCSV_Menu_Map1.csv"),HX_CSTRING("assets/levels/mapCSV_Menu_Map1.csv"));
			HX_STACK_LINE(190)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/levels/mapCSV_Menu_Map1.csv"),HX_CSTRING("text"));
			HX_STACK_LINE(191)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/levels/mapCSV_Tutorial_Map2.csv"),HX_CSTRING("assets/levels/mapCSV_Tutorial_Map2.csv"));
			HX_STACK_LINE(192)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/levels/mapCSV_Tutorial_Map2.csv"),HX_CSTRING("text"));
			HX_STACK_LINE(193)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/levels/mapCSV_Tutorial_Map3.csv"),HX_CSTRING("assets/levels/mapCSV_Tutorial_Map3.csv"));
			HX_STACK_LINE(194)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/levels/mapCSV_Tutorial_Map3.csv"),HX_CSTRING("text"));
			HX_STACK_LINE(195)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/levels/mapCSV_Win_Map1.csv"),HX_CSTRING("assets/levels/mapCSV_Win_Map1.csv"));
			HX_STACK_LINE(196)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/levels/mapCSV_Win_Map1.csv"),HX_CSTRING("text"));
			HX_STACK_LINE(197)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/levels/mapCSV_WorldMap_Map1.csv"),HX_CSTRING("assets/levels/mapCSV_WorldMap_Map1.csv"));
			HX_STACK_LINE(198)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/levels/mapCSV_WorldMap_Map1.csv"),HX_CSTRING("text"));
			HX_STACK_LINE(199)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/levels/mapCSV_WorldSelect_Map1.csv"),HX_CSTRING("assets/levels/mapCSV_WorldSelect_Map1.csv"));
			HX_STACK_LINE(200)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/levels/mapCSV_WorldSelect_Map1.csv"),HX_CSTRING("text"));
			HX_STACK_LINE(201)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/levels/tutorial.dam"),HX_CSTRING("assets/levels/tutorial.dam"));
			HX_STACK_LINE(202)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/levels/tutorial.dam"),HX_CSTRING("text"));
			HX_STACK_LINE(203)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/levels/tutorial.dam.bak"),HX_CSTRING("assets/levels/tutorial.dam.bak"));
			HX_STACK_LINE(204)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/levels/tutorial.dam.bak"),HX_CSTRING("text"));
			HX_STACK_LINE(205)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/levels/WorldMap.dam"),HX_CSTRING("assets/levels/WorldMap.dam"));
			HX_STACK_LINE(206)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/levels/WorldMap.dam"),HX_CSTRING("text"));
			HX_STACK_LINE(207)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/LevelThree.dam"),HX_CSTRING("assets/LevelThree.dam"));
			HX_STACK_LINE(208)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/LevelThree.dam"),HX_CSTRING("text"));
			HX_STACK_LINE(209)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/LevelThree.dam.bak"),HX_CSTRING("assets/LevelThree.dam.bak"));
			HX_STACK_LINE(210)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/LevelThree.dam.bak"),HX_CSTRING("text"));
			HX_STACK_LINE(211)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/LevelTwo.dam"),HX_CSTRING("assets/LevelTwo.dam"));
			HX_STACK_LINE(212)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/LevelTwo.dam"),HX_CSTRING("text"));
			HX_STACK_LINE(213)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/LevelTwo.dam.bak"),HX_CSTRING("assets/LevelTwo.dam.bak"));
			HX_STACK_LINE(214)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/LevelTwo.dam.bak"),HX_CSTRING("text"));
			HX_STACK_LINE(215)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/Menu.dam"),HX_CSTRING("assets/Menu.dam"));
			HX_STACK_LINE(216)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/Menu.dam"),HX_CSTRING("text"));
			HX_STACK_LINE(217)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/Platformer.dam"),HX_CSTRING("assets/Platformer.dam"));
			HX_STACK_LINE(218)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/Platformer.dam"),HX_CSTRING("text"));
			HX_STACK_LINE(219)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/platformTiles.png"),HX_CSTRING("assets/platformTiles.png"));
			HX_STACK_LINE(220)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/platformTiles.png"),HX_CSTRING("image"));
			HX_STACK_LINE(221)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/player.png"),HX_CSTRING("assets/player.png"));
			HX_STACK_LINE(222)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/player.png"),HX_CSTRING("image"));
			HX_STACK_LINE(223)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/power.png"),HX_CSTRING("assets/power.png"));
			HX_STACK_LINE(224)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/power.png"),HX_CSTRING("image"));
			HX_STACK_LINE(225)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/spriteTiles"),HX_CSTRING("assets/spriteTiles"));
			HX_STACK_LINE(226)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/spriteTiles"),HX_CSTRING("binary"));
			HX_STACK_LINE(227)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/spriteTiles.png"),HX_CSTRING("assets/spriteTiles.png"));
			HX_STACK_LINE(228)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/spriteTiles.png"),HX_CSTRING("image"));
			HX_STACK_LINE(229)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/Win.dam"),HX_CSTRING("assets/Win.dam"));
			HX_STACK_LINE(230)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/Win.dam"),HX_CSTRING("text"));
			HX_STACK_LINE(231)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/Win.dam.bak"),HX_CSTRING("assets/Win.dam.bak"));
			HX_STACK_LINE(232)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/Win.dam.bak"),HX_CSTRING("text"));
			HX_STACK_LINE(233)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/world.png"),HX_CSTRING("assets/world.png"));
			HX_STACK_LINE(234)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/world.png"),HX_CSTRING("image"));
			HX_STACK_LINE(237)
...
bool useCache = __o_useCache.Default(true);
	HX_STACK_PUSH("Assets::getBitmapData","nme/installer/Assets.hx",244);
	HX_STACK_ARG(id,"id");
		...
		if (((bool(::nme::installer::Assets_obj::resourceTypes->exists(id)) && bool((::nme::installer::Assets_obj::resourceTypes->get(id)->__Field(HX_CSTRING("toLowerCase"),true)() == HX_CSTRING("image")))))){
			...
			if (((id.indexOf(HX_CSTRING(":"),null()) > (int)-1))){
				...
				if ((::nme::installer::Assets_obj::libraryTypes->exists(libraryName))){
					...
					HX_STACK_LINE(307)
					::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no asset library named \"") + libraryName) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),309,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getBitmapData")));
				}
			}
			else{
				HX_STACK_LINE(313)
				::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no BitmapData asset with an ID of \"") + id) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),315,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getBitmapData")));
			}
		}
		HX_STACK_LINE(319)
		return null();
...
::native::utils::ByteArray Assets_obj::getBytes( ::String id){
	HX_STACK_PUSH("Assets::getBytes","nme/installer/Assets.hx",324);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(326)
	::nme::installer::Assets_obj::initialize();
	HX_STACK_LINE(328)
	if ((::nme::installer::Assets_obj::resourceNames->exists(id))){
		...
		HX_STACK_LINE(334)
		::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no String or ByteArray asset with an ID of \"") + id) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),334,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getBytes")));
		HX_STACK_LINE(336)
		return null();
	}
	HX_STACK_LINE(328)
...
::native::text::Font Assets_obj::getFont( ::String id){
	HX_STACK_PUSH("Assets::getFont","nme/installer/Assets.hx",343);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(345)
	::nme::installer::Assets_obj::initialize();
	HX_STACK_LINE(347)
	if (((bool(::nme::installer::Assets_obj::resourceTypes->exists(id)) && bool((::nme::installer::Assets_obj::resourceTypes->get(id)->__Field(HX_CSTRING("toLowerCase"),true)() == HX_CSTRING("font")))))){
		...
		HX_STACK_LINE(353)
		::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no Font asset with an ID of \"") + id) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),353,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getFont")));
		HX_STACK_LINE(355)
		return null();
	}
	HX_STACK_LINE(347)
...
::format::display::MovieClip Assets_obj::getMovieClip( ::String id){
	HX_STACK_PUSH("Assets::getMovieClip","nme/installer/Assets.hx",362);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(364)
	::nme::installer::Assets_obj::initialize();
	HX_STACK_LINE(366)
	...
	if ((::nme::installer::Assets_obj::libraryTypes->exists(libraryName))){
		...
		HX_STACK_LINE(403)
		::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no asset library named \"") + libraryName) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),405,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getMovieClip")));
	}
	HX_STACK_LINE(409)
	return null();
}
...
::String Assets_obj::getResourceName( ::String id){
	HX_STACK_PUSH("Assets::getResourceName","nme/installer/Assets.hx",414);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(416)
	::nme::installer::Assets_obj::initialize();
	HX_STACK_LINE(418)
...
::native::media::Sound Assets_obj::getSound( ::String id){
	HX_STACK_PUSH("Assets::getSound","nme/installer/Assets.hx",423);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(425)
	::nme::installer::Assets_obj::initialize();
	HX_STACK_LINE(427)
	...
	HX_STACK_LINE(441)
	::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no Sound asset with an ID of \"") + id) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),441,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getSound")));
	HX_STACK_LINE(443)
	return null();
}
...
::String Assets_obj::getText( ::String id){
	HX_STACK_PUSH("Assets::getText","nme/installer/Assets.hx",448);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(450)
