...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(15)
		::nme::Lib_obj::setPackage(HX_CSTRING("Zaphod"),HX_CSTRING("JustEnough"),HX_CSTRING("com.example.myapp"),HX_CSTRING("0.0.1"));
		...
		HX_STACK_LINE(39)
		::nme::Lib_obj::create( Dynamic(new _Function_1_1()),(int)640,(int)480,(int)60,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::nme::Lib_obj::HARDWARE) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::nme::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int(::nme::Lib_obj::FULLSCREEN))) | int((int)0))) | int((int)0)),HX_CSTRING("JustEnough"),null());
	}
return null();
}
...
Dynamic ApplicationMain_obj::getAsset( ::String inName){
	...
	HX_STACK_LINE(114)
	if (((inName == HX_CSTRING("Pickup")))){
		HX_STACK_LINE(115)
		return ::nme::installer::Assets_obj::getSound(HX_CSTRING("Pickup"));
	}
	HX_STACK_LINE(121)
	if (((inName == HX_CSTRING("Click")))){
		HX_STACK_LINE(122)
		return ::nme::installer::Assets_obj::getSound(HX_CSTRING("Click"));
	}
	HX_STACK_LINE(128)
	if (((inName == HX_CSTRING("Jump")))){
		HX_STACK_LINE(129)
		return ::nme::installer::Assets_obj::getSound(HX_CSTRING("Jump"));
	}
	HX_STACK_LINE(135)
	if (((inName == HX_CSTRING("Hurt")))){
		HX_STACK_LINE(136)
		return ::nme::installer::Assets_obj::getSound(HX_CSTRING("Hurt"));
	}
	HX_STACK_LINE(142)
	if (((inName == HX_CSTRING("Ambient")))){
		HX_STACK_LINE(143)
		return ::nme::installer::Assets_obj::getSound(HX_CSTRING("Ambient"));
	}
	HX_STACK_LINE(149)
	if (((inName == HX_CSTRING("Upbeat")))){
		HX_STACK_LINE(150)
		return ::nme::installer::Assets_obj::getSound(HX_CSTRING("Upbeat"));
	}
	HX_STACK_LINE(156)
	if (((inName == HX_CSTRING("Beat")))){
		HX_STACK_LINE(157)
		return ::nme::installer::Assets_obj::getSound(HX_CSTRING("Beat"));
	}
	HX_STACK_LINE(163)
	if (((inName == HX_CSTRING("assets/beebTiles.pxi")))){
		HX_STACK_LINE(164)
		return ::nme::installer::Assets_obj::getBytes(HX_CSTRING("assets/beebTiles.pxi"));
	}
	HX_STACK_LINE(170)
	if (((inName == HX_CSTRING("assets/cPower.png")))){
		HX_STACK_LINE(171)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("assets/cPower.png"),null());
	}
	HX_STACK_LINE(177)
	...
	HX_STACK_LINE(282)
	if (((inName == HX_CSTRING("assets/data/click.wav")))){
		HX_STACK_LINE(283)
		return ::nme::installer::Assets_obj::getSound(HX_CSTRING("assets/data/click.wav"));
	}
	HX_STACK_LINE(289)
	...
	HX_STACK_LINE(310)
	if (((inName == HX_CSTRING("assets/data/etherial_hibpm.mp3")))){
		HX_STACK_LINE(311)
		return ::nme::installer::Assets_obj::getSound(HX_CSTRING("assets/data/etherial_hibpm.mp3"));
	}
	HX_STACK_LINE(317)
	...
	HX_STACK_LINE(338)
	if (((inName == HX_CSTRING("assets/data/hurt.wav")))){
		HX_STACK_LINE(339)
		return ::nme::installer::Assets_obj::getSound(HX_CSTRING("assets/data/hurt.wav"));
	}
	HX_STACK_LINE(345)
	if (((inName == HX_CSTRING("assets/data/jump.wav")))){
		HX_STACK_LINE(346)
		return ::nme::installer::Assets_obj::getSound(HX_CSTRING("assets/data/jump.wav"));
	}
	HX_STACK_LINE(352)
	...
	HX_STACK_LINE(380)
	if (((inName == HX_CSTRING("assets/data/pickup.wav")))){
		HX_STACK_LINE(381)
		return ::nme::installer::Assets_obj::getSound(HX_CSTRING("assets/data/pickup.wav"));
	}
	HX_STACK_LINE(387)
	if (((inName == HX_CSTRING("assets/data/standard_beat.mp3")))){
		HX_STACK_LINE(388)
		return ::nme::installer::Assets_obj::getSound(HX_CSTRING("assets/data/standard_beat.mp3"));
	}
	HX_STACK_LINE(394)
	...
	HX_STACK_LINE(401)
	if (((inName == HX_CSTRING("assets/data/surreal_ambient.mp3")))){
		HX_STACK_LINE(402)
		return ::nme::installer::Assets_obj::getSound(HX_CSTRING("assets/data/surreal_ambient.mp3"));
	}
	HX_STACK_LINE(408)
	...
	HX_STACK_LINE(478)
	if (((inName == HX_CSTRING("assets/door.png")))){
		HX_STACK_LINE(479)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("assets/door.png"),null());
	}
	HX_STACK_LINE(485)
	if (((inName == HX_CSTRING("assets/goal")))){
		HX_STACK_LINE(486)
		return ::nme::installer::Assets_obj::getBytes(HX_CSTRING("assets/goal"));
	}
	HX_STACK_LINE(492)
	if (((inName == HX_CSTRING("assets/goal.png")))){
		HX_STACK_LINE(493)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("assets/goal.png"),null());
	}
	HX_STACK_LINE(499)
	...
	HX_STACK_LINE(506)
	if (((inName == HX_CSTRING("assets/health.png")))){
		HX_STACK_LINE(507)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("assets/health.png"),null());
	}
	HX_STACK_LINE(513)
	...
	HX_STACK_LINE(520)
	if (((inName == HX_CSTRING("assets/LevelFour.dam")))){
		HX_STACK_LINE(521)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/LevelFour.dam"));
	}
	HX_STACK_LINE(527)
	if (((inName == HX_CSTRING("assets/LevelFour.dam.bak")))){
		HX_STACK_LINE(528)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/LevelFour.dam.bak"));
	}
	HX_STACK_LINE(534)
	if (((inName == HX_CSTRING("assets/levelOne.dam")))){
		HX_STACK_LINE(535)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/levelOne.dam"));
	}
	HX_STACK_LINE(541)
	if (((inName == HX_CSTRING("assets/levelOne.dam.bak")))){
		HX_STACK_LINE(542)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/levelOne.dam.bak"));
	}
	HX_STACK_LINE(548)
	if (((inName == HX_CSTRING("assets/levels/mapCSV_Group1_Map1.csv")))){
		HX_STACK_LINE(549)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/levels/mapCSV_Group1_Map1.csv"));
	}
	HX_STACK_LINE(555)
	if (((inName == HX_CSTRING("assets/levels/mapCSV_Group1_Map2.csv")))){
		HX_STACK_LINE(556)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/levels/mapCSV_Group1_Map2.csv"));
	}
	HX_STACK_LINE(562)
	if (((inName == HX_CSTRING("assets/levels/mapCSV_LevelFour_Map1.csv")))){
		HX_STACK_LINE(563)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/levels/mapCSV_LevelFour_Map1.csv"));
	}
	HX_STACK_LINE(569)
	if (((inName == HX_CSTRING("assets/levels/mapCSV_LevelFour_Map2.csv")))){
		HX_STACK_LINE(570)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/levels/mapCSV_LevelFour_Map2.csv"));
	}
	HX_STACK_LINE(576)
	if (((inName == HX_CSTRING("assets/levels/mapCSV_levelOne_Map1.csv")))){
		HX_STACK_LINE(577)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/levels/mapCSV_levelOne_Map1.csv"));
	}
	HX_STACK_LINE(583)
	if (((inName == HX_CSTRING("assets/levels/mapCSV_levelOne_Map2.csv")))){
		HX_STACK_LINE(584)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/levels/mapCSV_levelOne_Map2.csv"));
	}
	HX_STACK_LINE(590)
	if (((inName == HX_CSTRING("assets/levels/mapCSV_LevelThree_Map1.csv")))){
		HX_STACK_LINE(591)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/levels/mapCSV_LevelThree_Map1.csv"));
	}
	HX_STACK_LINE(597)
	if (((inName == HX_CSTRING("assets/levels/mapCSV_LevelThree_Map2.csv")))){
		HX_STACK_LINE(598)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/levels/mapCSV_LevelThree_Map2.csv"));
	}
	HX_STACK_LINE(604)
	if (((inName == HX_CSTRING("assets/levels/mapCSV_LevelTwo_Map1.csv")))){
		HX_STACK_LINE(605)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/levels/mapCSV_LevelTwo_Map1.csv"));
	}
	HX_STACK_LINE(611)
	if (((inName == HX_CSTRING("assets/levels/mapCSV_LevelTwo_Map2.csv")))){
		HX_STACK_LINE(612)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/levels/mapCSV_LevelTwo_Map2.csv"));
	}
	HX_STACK_LINE(618)
	if (((inName == HX_CSTRING("assets/levels/mapCSV_Menu_Map1.csv")))){
		HX_STACK_LINE(619)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/levels/mapCSV_Menu_Map1.csv"));
	}
	HX_STACK_LINE(625)
	if (((inName == HX_CSTRING("assets/levels/mapCSV_Tutorial_Map2.csv")))){
		HX_STACK_LINE(626)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/levels/mapCSV_Tutorial_Map2.csv"));
	}
	HX_STACK_LINE(632)
	if (((inName == HX_CSTRING("assets/levels/mapCSV_Tutorial_Map3.csv")))){
		HX_STACK_LINE(633)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/levels/mapCSV_Tutorial_Map3.csv"));
	}
	HX_STACK_LINE(639)
	if (((inName == HX_CSTRING("assets/levels/mapCSV_Win_Map1.csv")))){
		HX_STACK_LINE(640)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/levels/mapCSV_Win_Map1.csv"));
	}
	HX_STACK_LINE(646)
	if (((inName == HX_CSTRING("assets/levels/mapCSV_WorldMap_Map1.csv")))){
		HX_STACK_LINE(647)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/levels/mapCSV_WorldMap_Map1.csv"));
	}
	HX_STACK_LINE(653)
	if (((inName == HX_CSTRING("assets/levels/mapCSV_WorldSelect_Map1.csv")))){
		HX_STACK_LINE(654)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/levels/mapCSV_WorldSelect_Map1.csv"));
	}
	HX_STACK_LINE(660)
	if (((inName == HX_CSTRING("assets/levels/tutorial.dam")))){
		HX_STACK_LINE(661)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/levels/tutorial.dam"));
	}
	HX_STACK_LINE(667)
	if (((inName == HX_CSTRING("assets/levels/tutorial.dam.bak")))){
		HX_STACK_LINE(668)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/levels/tutorial.dam.bak"));
	}
	HX_STACK_LINE(674)
	if (((inName == HX_CSTRING("assets/levels/WorldMap.dam")))){
		HX_STACK_LINE(675)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/levels/WorldMap.dam"));
	}
	HX_STACK_LINE(681)
	if (((inName == HX_CSTRING("assets/LevelThree.dam")))){
		HX_STACK_LINE(682)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/LevelThree.dam"));
	}
	HX_STACK_LINE(688)
	if (((inName == HX_CSTRING("assets/LevelThree.dam.bak")))){
		HX_STACK_LINE(689)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/LevelThree.dam.bak"));
	}
	HX_STACK_LINE(695)
	if (((inName == HX_CSTRING("assets/LevelTwo.dam")))){
		HX_STACK_LINE(696)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/LevelTwo.dam"));
	}
	HX_STACK_LINE(702)
	if (((inName == HX_CSTRING("assets/LevelTwo.dam.bak")))){
		HX_STACK_LINE(703)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/LevelTwo.dam.bak"));
	}
	HX_STACK_LINE(709)
	if (((inName == HX_CSTRING("assets/Menu.dam")))){
		HX_STACK_LINE(710)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/Menu.dam"));
	}
	HX_STACK_LINE(716)
	if (((inName == HX_CSTRING("assets/Platformer.dam")))){
		HX_STACK_LINE(717)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/Platformer.dam"));
	}
	HX_STACK_LINE(723)
	if (((inName == HX_CSTRING("assets/platformTiles.png")))){
		HX_STACK_LINE(724)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("assets/platformTiles.png"),null());
	}
	HX_STACK_LINE(730)
	...
	HX_STACK_LINE(737)
	if (((inName == HX_CSTRING("assets/power.png")))){
		HX_STACK_LINE(738)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("assets/power.png"),null());
	}
	HX_STACK_LINE(744)
	if (((inName == HX_CSTRING("assets/spriteTiles")))){
		HX_STACK_LINE(745)
		return ::nme::installer::Assets_obj::getBytes(HX_CSTRING("assets/spriteTiles"));
	}
	HX_STACK_LINE(751)
	if (((inName == HX_CSTRING("assets/spriteTiles.png")))){
		HX_STACK_LINE(752)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("assets/spriteTiles.png"),null());
	}
	HX_STACK_LINE(758)
	if (((inName == HX_CSTRING("assets/Win.dam")))){
		HX_STACK_LINE(759)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/Win.dam"));
	}
	HX_STACK_LINE(765)
	if (((inName == HX_CSTRING("assets/Win.dam.bak")))){
		HX_STACK_LINE(766)
		return ::nme::installer::Assets_obj::getText(HX_CSTRING("assets/Win.dam.bak"));
	}
	HX_STACK_LINE(772)
	if (((inName == HX_CSTRING("assets/world.png")))){
		HX_STACK_LINE(773)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("assets/world.png"),null());
	}
	HX_STACK_LINE(780)
	return null();
}
