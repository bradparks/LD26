...
{
HX_STACK_PUSH("World::new","com/jah2488/ld48/enough/Tiles.hx",38);
{
	HX_STACK_LINE(39)
	super::__construct();
	HX_STACK_LINE(40)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.jah2488.ld48.enough.World"), hx::TCanCast< World_obj> ,sStaticFields,sMemberFields,
