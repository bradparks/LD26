...
#define INCLUDED_com_jah2488_ld48_enough_Spike
...
HX_DECLARE_CLASS4(com,jah2488,ld48,enough,Spike)
...
class Spike_obj : public ::com::jah2488::ld48::enough::Tile_obj{
	public:
	...
	public:
		static hx::ObjectPtr< Spike_obj > __new(Float x,Float y);
...
#endif /* INCLUDED_com_jah2488_ld48_enough_Spike */ 
