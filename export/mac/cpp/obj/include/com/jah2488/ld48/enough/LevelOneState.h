...
#define INCLUDED_com_jah2488_ld48_enough_LevelOneState
...
HX_DECLARE_CLASS4(com,jah2488,ld48,enough,LevelOneState)
...
class LevelOneState_obj : public ::com::jah2488::ld48::enough::PlatformState_obj{
	public:
		typedef ::com::jah2488::ld48::enough::PlatformState_obj super;
		typedef LevelOneState_obj OBJ_;
		LevelOneState_obj();
		Void __construct();

	public:
		static hx::ObjectPtr< LevelOneState_obj > __new();
		...
		::String __ToString() const { return HX_CSTRING("LevelOneState"); }
...
#endif /* INCLUDED_com_jah2488_ld48_enough_LevelOneState */ 
