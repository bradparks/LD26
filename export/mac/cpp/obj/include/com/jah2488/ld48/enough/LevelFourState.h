...
#define INCLUDED_com_jah2488_ld48_enough_LevelFourState
...
HX_DECLARE_CLASS4(com,jah2488,ld48,enough,LevelFourState)
...
class LevelFourState_obj : public ::com::jah2488::ld48::enough::PlatformState_obj{
	public:
		typedef ::com::jah2488::ld48::enough::PlatformState_obj super;
		typedef LevelFourState_obj OBJ_;
		LevelFourState_obj();
		Void __construct();

	public:
		static hx::ObjectPtr< LevelFourState_obj > __new();
		...
		::String __ToString() const { return HX_CSTRING("LevelFourState"); }
...
#endif /* INCLUDED_com_jah2488_ld48_enough_LevelFourState */ 
